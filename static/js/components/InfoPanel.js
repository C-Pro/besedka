    ...
    container.innerHTML = `
        <div class="info-header">
            ...
            <div class="profile-menu-container" id="desktop-profile-menu">
                ...
                <div class="profile-dropdown" id="desktop-profile-dropdown">
                    ...
                    <button class="profile-menu-item" id="desktop-settings-btn" type="button">Settings</button>
        ...
        <div class="info-content">
            ...
            <div class="info-section">
                ...
                <div id="location-map" class="location-map-container" style="width: 100%; height: 200px; border-radius: 8px; overflow: hidden; position: relative;">
                </div>
            </div>
        </div>
    `;
